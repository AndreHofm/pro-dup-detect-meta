...
public class Main {
    public static void main(String[] args) {
        String input = "/Users/andrehofmann/Documents/Uni/Bachelorarbeit/Code/pro-dup-detect-meta/src/main/java/de/pdd_metadata/duplicate_detection/test.csv";

        DataReader dataReader = new DataReader(input, true, ',', 0, 100);

        Blocking blocking = new Blocking(4, dataReader, 0.6, 4, 2000000);
